...
<hr />
<button class='btn btn-primary btn-lg m-1 redirect' data-url='@Url.Action("Index", "Request")'>Request</button>
<button class='btn btn-primary btn-lg m-1 redirect' data-url='@Url.Action("Index", "Software")'>Software</button>
<button class='btn btn-primary btn-lg m-1 redirect' data-url='@Url.Action("Index", "Donate")'>Donate</button>
<hr />
<h2>Services</h2>
<dl>
