...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $postedValue = $_POST["message"];
    echo "You submitted: " . htmlspecialchars($postedValue);
}
?>
<form method="post">
<h1>Request</h1>
...
<div><input type="textbox" name="name"></div>
<div><label>Email Address</label></div>
<div><input type="textbox" name="email_address"></div>
<div><label>Message</label></div>
<div class="md-form"><textarea class="md-textarea form-control" rows=5 name="message"></textarea></div>
<div><label>Due Date</label></div>
<div><div><input type="textbox" name="due_date"></div></div>
<br />
<div>
